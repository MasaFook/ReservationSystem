...
namespace ReservationSystem.Services
{
    public class ItemService : IItemService
    {
        ...
        {
            IEnumerable<Item> items = await _repository.GetAllItemsAsync();
        ...
        public async Task<IEnumerable<ItemDTO>> GetAllItemsAsync(string username)
        {
            ...
            IEnumerable<Item> items = await _repository.GetAllItemsAsync(owner);
            List<ItemDTO> itemDTOs = new List<ItemDTO>();
            foreach (Item i in items)
            {
                itemDTOs.Add(ItemToDTO(i));
