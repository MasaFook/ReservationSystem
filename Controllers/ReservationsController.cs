...
namespace ReservationSystem.Controllers
{
    ...
    public class ReservationsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Reservation>>> GetReservations() // hakee kaikki varaukset
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Reservation>> GetReservation(long id) // hakee yhden varauksen id:n mukaan
        {
        ...
        [HttpPut("{id}")]
        [Authorize]
        public async Task<IActionResult> PutReservation(long id, ReservationDTO reservation) //päivittää varauksen
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteReservation(long id) //poistaa varauksen
        {
            var reservation = await _context.Reservations.FindAsync(id);
            if (reservation == null)
            {
